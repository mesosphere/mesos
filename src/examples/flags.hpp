...
#ifndef __EXAMPLE_FLAGS_HPP__
#define __EXAMPLE_FLAGS_HPP__
...
// TODO(tillt): Unify the example framework options further to allow
// more grouping of flags.

class CheckpointFlags : public virtual flags::FlagsBase
{
public:
  CheckpointFlags()
  {
    add(&CheckpointFlags::checkpoint,
        "checkpoint",
...
class RoleFlags : public virtual flags::FlagsBase
{
public:
  RoleFlags()
  {
